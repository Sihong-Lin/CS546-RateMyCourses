                ...
                n.removeAttribute(e),
                    Array.prototype.forEach.call(n.attributes, function (e) {
                        /^on/.test(e.name) &&
                            ...
                            n.setAttribute(
                                e.name,
                                e.value.substring(t.handlerPrefixLength)
                            );
                    });
            }
        );
        ...
        D = (function () {
            ...
            return (
                ...
                (t.prototype.hasNonce = function (t) {
                    return (
                        0 === (t.getAttribute('type') || '').indexOf(this.nonce)
                    );
                }),
                    ...
                    (document.write = L),
                        ...
                        this.buffer.length &&
                            (document.contains(this.insertionPointMarker)
                                ? this.insertionPointMarker.parentNode ===
                                  document.head
        ...
        j = (function () {
            function t() {
                ...
                (this.simulatedReadyState = 'loading'),
                    ...
                    (this.nativeWindowAddEventListener =
            ...
            return (
                (t.prototype.runOnLoad = function (t) {
                    var e = this;
                    this.nativeWindowAddEventListener.call(
                        window,
                        'load',
                        function (n) {
                ...
                (t.prototype.simulateStateBeforeDeferScriptsActivation =
                    function () {
                ...
                (t.prototype.simulateStateAfterDeferScriptsActivation =
                    function () {
                        var t = this;
                        (this.bypassEventsInProxies = !0),
                ...
                (t.prototype.proxyInlineHandler = function (t, e) {
                    try {
                        ...
                        return void console.warn(
                            'encountered an error when accessing ' +
                                e +
                                ' handler:',
                            o.message
                        );
                    ...
                    for (var t = this, e = this; this.scriptStack.hasItems; ) {
                        var n = (function () {
                            ...
                            return o
                                ...
                                : (n && n.flushWrittenContentAndDisable(),
                                  'continue');
                        })();
